...
This document is up-to-date with **Python 3.13**.
...
* **[argparse](https://docs.python.org/3/library/argparse.html)** - framework for handling command-line arguments. [getopt](https://docs.python.org/3/library/getopt.html) allows for doing the same with a C-style approach. [docopt](http://docopt.org/) is a pythonic third-party library that offers a [domain-specific language](https://en.wikipedia.org/wiki/Domain-specific_language) for describing your command-line input and options.
